        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header with-border">
              ...
              <a href="deduction_toggle.php" class="btn btn-warning btn-sm btn-flat">
                <i class="fa fa-power-off"></i> Enable / Disable All
              </a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT * FROM deductions WHERE status = 1";
