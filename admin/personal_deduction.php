...
<button
  class="btn btn-primary btn-sm btn-flat addnew"
...
<?php include 'includes/personal_deduction_modal.php'; ?>
...
function getRow(id){
  ...
  $.ajax({
    ...
    url: 'personal_deduction_row.php',
    ...
    success: function(response){
      ...
      $('#del_personal_deduction').html(response.description);
